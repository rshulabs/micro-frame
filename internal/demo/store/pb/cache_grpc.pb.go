...
const (
	Demo_Get_FullMethodName = "/hgcache.cache.Demo/Get"
)
...
func (c *demoClient) Get(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedDemoServer) Get(context.Context, *Request) (*Response, error) {
...
func _Demo_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).Get(ctx, req.(*Request))
	}
...
var Demo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hgcache.cache.Demo",
	...
	Metadata: "internal/demo/store/pb/cache.proto",
}
